...
vsh = sqrt(Sample.c66_fiber / rho_ply);
vsv = sqrt(Sample.c44_fiber / rho_ply);

half_c66_c44 = (Sample.c66_fiber+Sample.c44_fiber)/2;
 
E_equal  = half_c66_c44*(3*Sample.c22_fiber-4*half_c66_c44)/(Sample.c22_fiber-half_c66_c44);

nu_equal = (Sample.c22_fiber - 2*half_c66_c44)/2/(Sample.c22_fiber-half_c66_c44); 

sqrt(stiffness_matrix(1, 1)/ rho_ply)
...
writematrix(mat_paras, 'anisotroic_material_prop_0_45_90_135.txt','Delimiter','tab')
