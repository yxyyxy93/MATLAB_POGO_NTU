...
dir_path = './test_woven_onlyshear/';  % Current directory
dir_path = './test_woven_onlyorient/';  % Current directory
% dir_path = './test_woven_only090/';  % Current directory
dir_path = './test_woven_090_tight/';  % Current directory
% dir_path = './test_woven_#(090)#(075)/';
...
save([dir_path, dir_path(2:end-1), '_4l', '_', dateString, '_10m_diamond'], 'Ascans_reim');
